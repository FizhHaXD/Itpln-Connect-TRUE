...
if (isset($_POST['register'])) {
    ...
    $checkEmail = mysqli_query($conn, "SELECT id_user FROM users WHERE email='$email'");
...
<html lang="id">
<head>
  <title>Daftar - ITPLN Connect</title>
  <meta charset="UTF-8">
...
<div style="min-height:100vh; display:flex; align-items:center; justify-content:center; padding:24px; background:var(--bg);">
  <div style="width:100%; max-width:420px;">
    ...
    <div style="text-align:center; margin-bottom:32px;">
      ...
      <p style="color:var(--text-muted); font-size:0.9rem;">Buat akun baru kamu</p>
    </div>

    <div class="card" style="padding:32px;">
      <a href="login.php" class="btn btn-sm btn-outline-primary" style="margin-bottom:20px;">
        <i class="fa-solid fa-arrow-left"></i> Kembali
      </a>
      
      <h2 style="font-size:1.4rem; margin-bottom:4px;">Daftar Akun</h2>
      <p style="color:var(--text-muted); font-size:0.88rem; margin-bottom:24px;">Bergabung dengan komunitas kampus</p>
      ...
      <form method="POST">
        ...
        <button class="btn" name="register" style="width:100%; justify-content:center; margin-top:4px;">
